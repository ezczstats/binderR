...
If you are receiving this message you are in the summer or fall Intro to Statistics Boot Camp with me. Atttached is a check-in video to introduce you to the interface we will be using during your session.

Here is a reminder video from RStudio to about R/RStudio installation. Please make sure BOTH are installed before your session starts.
  https://learnr-examples.shinyapps.io/ex-setup-r/#section-welcome
    
Note: I mention 1-1 resume building sessions that I will be conducting weekly. More to come on this, but I wanted to let you know that it's one of the many exciting extras that come with the boot camp. We will sit down and talk about building a strong portfolio for potential employers (both sports and non-sports). This will include: properly storing source code, building your own apps, creating blogs, and more. These sessions will be 30 minutes per student each week, for a total of 2 hours of 1-1 resume/portfolio building.

Also, I heard some previous video links didn't open in one of my welcome ppt slides. Not sure what happened, here they are!

https://www.youtube.com/watch?v=9rOKGKhQe8U&t=0s
https://www.youtube.com/watch?v=vjzKKQhI7rM
https://www.youtube.com/watch?v=oUvvfHkXyOA
https://www.youtube.com/watch?v=mq3v8fN1x8k
